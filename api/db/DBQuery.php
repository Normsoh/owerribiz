...
class DBQuery extends DBConnection {
    public function insertUser ($fullname, $email, $password, $gender, $dob, $address, $stateOfOrigin, $lgaOfOrigin, $stateOfResidence, $lgaOfResidence, $profile_img) {
    ...
    public function editUser ($fullname, $gender, $dob, $address, $stateOfOrigin, $lgaOfOrigin, $stateOfResidence, $lgaOfResidence, $profile_img, $email) {
