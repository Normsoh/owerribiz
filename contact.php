            ...
            <div class="row">
               <div class="col-lg-4">
                  <div class="single-intro-text single-contact-feature">
                     ...
                     <p>
                        <strong>Name:</strong> Innocent Unachukwu
                     </p>
                     <p>
               ...
               <div class="col-lg-4">
                  <div class="single-intro-text single-contact-feature">
                     ...
                     <p>
                        <strong>Name:</strong> Bright Remy
                     </p>
                     <p>
                        <strong>Phone:</strong> 080-6418-4580
                     </p>
                     <p>
                        <strong>Email:</strong> info@owerribusinesslinkagesforum.com
                     </p>
                     <span class="count-number fa fa-paper-plane"></span>
                  </div><!-- single intro text end-->
                  <div class="border-shap left"></div>
               ...
               <div class="col-lg-4">
                  <div class="single-intro-text single-contact-feature">
                     ...
                     <p>
                        <strong>Name:</strong> Godwin Kachi
                     </p>
                     <p>
                        <strong>Phone:</strong> 080-7565-7368
                     </p>
                     <p>
                        <strong>Email:</strong> info@owerribusinesslinkagesforum.com
                     </p>
               ...
               <div class="col-lg-4">
                  <div class="single-intro-text single-contact-feature">
                     <h3 class="ts-title">Sponsorship</h3>
                     <p>
                        <strong>Name:</strong> Nkemjika Okeke
                     </p>
                     <p>
                        <strong>Phone:</strong> 080-7565-7368
                     </p>
               ...
               <div class="col-lg-4">
                  <div class="single-intro-text single-contact-feature">
                     <h3 class="ts-title">Exhibition</h3>
                     <p>
                        <strong>Name:</strong> Chukwuma Anurunkem
                     </p>
                     <p>
                        <strong>Phone:</strong> 009-215-5595
                     </p>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              <input class="form-control form-control-name" placeholder="First Name" name="name" id="f-name" type="text" required>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              <input class="form-control form-control-name" placeholder="Last Name" name="name" id="l-name" type="text" required>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
