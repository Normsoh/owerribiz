		...
		<div id="page-banner-area" class="page-banner-area" style="background-image:url(./images/hero_area/banner_bg.jpg)">
			...
			<div class="page-banner-title">
				<div class="text-center">
					...
					<ol class="breadcrumb">
						<li>
							<a href="#">Owerri business linkages forum/</a>
						</li>
						<li>
							Blog Details
						</li>
							...
							<div class="post-content post-single">
								...
								<nav class="post-navigation clearfix mrtb-40">
									<div class="post-previous">
										<a href="#">
											<h3>Cloud Hosting growing faster todays</h3><span><i class="fa fa-long-arrow-left"></i>Previous Post</span>
										</a>
									</div>
									<div class="post-next">
										<a href="#">
											<h3>Cloud Hosting growing faster todays</h3><span>Next Post <i class="fa fa-long-arrow-right"></i></span>
										</a>
									</div>
								</nav>
