...
.input_label{
  ...
  color: blue;
    ...
    <body>
       <div>
        <br>
       <div class="text-center"> <img src="images/remy.png" alt="logo"></div>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" name="surname" value="" data-validation="required" 
     data-validation-error-msg="Please Enter Surname.">
  </div>
  <div class="form-group">
    <label class="input_label">Email</label>
    <input type="text" class="form-control" name="email"  value="" data-validation="required" 
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="oname"   value="" data-validation="required" 
     data-validation-error-msg="Please Enter Other Names.">
  </div>
  <div class="form-group">
    <label class="input_label">Phone Number</label>
    <input type="text" class="form-control" name="phone"  value="" data-validation="required" 
     data-validation-error-msg="Please Enter Phone Number.">
  </div>
  </div>
...
<select name="State" class="form-control" data-validation="required" 
     data-validation-error-msg="Please Select State" >
...
<input type="text" class="form-control" name="prof"   value="" data-validation="required" 
     data-validation-error-msg="Please Enter Profession.">
 </div>
</div>
...
<input type="text" class="form-control" name="cor"   value="" data-validation="required" 
     data-validation-error-msg="Please Enter City of Residence.">
 </div>
</div>
...
<input type="text" class="form-control" name="cnor"   value="" data-validation="required" 
     data-validation-error-msg="Please Enter Country of Residence.">
 </div>
</div>
  </div>
  <div class="row">
    <div class="col-md-4">
     <div class="form-group">
      <label class="input_label">Owerribizforum belong to</label>
<input type="text" class="form-control" name="dobt"   value="" data-validation="required" 
     data-validation-error-msg="Please Enter Diaspora Organizations you belong.">
 </div>
</div>
...
<select name="ioi" class="form-control" data-validation="required" 
     data-validation-error-msg="Please Select Industries of interest" >
     <option value=""></option>
...
<select name="noi" class="form-control" data-validation="required" 
     data-validation-error-msg="Please Select Nature of interest" >
      <option value=""></option>
...
<div class="form-group">
 ...
 <div class="form-group">
    <label class="input_label">Suggestions for the sponsors.</label>
    <textarea class="form-control" rows="3" name="sisg"></textarea>
  </div>
